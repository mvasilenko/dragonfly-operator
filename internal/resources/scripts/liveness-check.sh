...
# Liveness: just verify the port is open (process is alive and accepting connections)
timeout 4 nc -q1 $HOST $PORT </dev/null
# timeout 4 must be < K8s probe timeoutSeconds (5). Rule: script timeout = timeoutSeconds - 1.
